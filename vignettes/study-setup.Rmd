...
The analytics pipeline stores workflow lists, summaries, and other objects that cannot be written as flat Parquet tables. Set `save_rds = TRUE` to write a companion `analytics_full.rds` file per snapshot:
